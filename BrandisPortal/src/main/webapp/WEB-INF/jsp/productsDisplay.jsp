		...
		<div id="slidingTopWrap">
			...
			<div id="slidingTopFooter">
				<div id="slidingTopFooterLeft">
					<img alt="Show Basket" src="<c:url value="/resources/images/arrow-up.png"/>" /> <a href="no-js.htm" class="slidingTopTrigger" onclick="return false;">Hide Basket</a>
				</div>
			</div>
		</div>
	</div>
	<div id="productsDiv">
		<img src="<c:url value="/resources/images/proinv.JPG"/>" />
		<ul id="productList">
