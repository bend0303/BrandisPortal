				...
				<div>
					<table width="100%">
						<tr>
							...
							<td align="center">
								<input type="image" src="<c:url value="/resources/images/shoppingCart.png"/>" title="Add Item To Cart" class="shoppingCartIMG"  name="idForCart" value="${p.productId}">
								<input	style="font-size: 12px;" class="spinner" name="amount<c:out value="${p.productId}"/>" />
							</td>
						</tr>
						<tr>
							<td class="productDesc"><c:out value="${p.productDesc}" /></td>
							<td align="center" class="productDesc"><b>Price: </b> 
							<span class="price"><c:out value="${p.productPrice}" /></span></td>
						</tr>
					</table>
				</div>
			</li>
